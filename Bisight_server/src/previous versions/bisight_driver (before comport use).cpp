...
bool Bisight::getJointPosition(int jnt, double &retValue) {
...
bool Bisight::getJointPositions(double *value) {
 ...
 */
bool Bisight::setJointPosition(int jnt, double val) {
	char cmd[32];
	int value[1];
 ...
 * @param value the position in radians
 */
bool Bisight::setJointPositions(double *val) {
	int i;
	for (i=0; i<4; i++) {	
