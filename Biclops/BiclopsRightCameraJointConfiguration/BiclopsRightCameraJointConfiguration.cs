 ...
 * Note: SOU (June/2009)
 * 
 * The BiclopsRightJointConfiguration Service connects to the Biclops service
...
namespace UMass.LPR.BiclopsRightCameraJointConfiguration
{
	[Contract(Contract.Identifier)]
    [AlternateContract(jointconfig.Contract.Identifier)]
    [DisplayName("BiclopsRightCameraJointConfiguration")]
    [Description("BiclopsRightCameraJointConfiguration service")]
	class BiclopsRightCameraJointConfigurationService : DsspServiceBase
	{
        /// <summary>
        /// _state
        /// </summary>
        [InitialStatePartner(Optional = true, ServiceUri = ServicePaths.Store + "\\biclopsrightcamerajointconfiguration.xml")]
        ...
        /// <summary>
        /// </summary>
        [ServicePort("/BiclopsRightCameraJointConfiguration", AllowMultipleInstances = false)]
        ...
        [EmbeddedResource("UMass.LPR.BiclopsRightCameraJointConfiguration.BiclopsRightCameraJointConfiguration.xslt")]
        string _transform = null;

        // http util port for reading from http page
        DsspHttpUtilitiesPort _httpUtilities;

        // port to Biclops brick (change this to work with simulated biclops)
        biclops.BiclopsOperations _biclopsPort;

		public BiclopsRightCameraJointConfigurationService(DsspServiceCreationPort creationPort)
			: base(creationPort)
		{
		}
