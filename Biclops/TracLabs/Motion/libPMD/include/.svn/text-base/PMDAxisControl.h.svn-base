...
public:
    ...
    unsigned long GetCountsPerEncoderCycle () {return countsPerEncoderCycle;};
    double CountsToUnits(PMDint32 val) {return ((double)((int)val))/countsPerAxisCycle;};
    PMDint32 UnitsToCounts(double val) {return (PMDint32)(val*countsPerAxisCycle);};
